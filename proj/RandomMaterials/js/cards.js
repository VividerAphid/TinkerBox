...
function buildCard(props){
    //Takes in title, class, image, colour, link address, desc, parent
    addElement({type: "div", id: props.title+"Card", class: props.class, parent: props.parent, innards:""});//Card body
    ...
    if(props.image){addElement({type:"div", id: props.title + "-picture", class:"cardPicture", parent:currentCard, innards:props.image});}//Card picture
    ...
    if(props.linkAddress){addElement({type:"div", id: props.title + "-link", class:"cardLink", parent:currentCard, innards:props.linkAddress});}//Link Address
    currentCard.style.backgroundColor = props.colour;
    //console.log(props.title + "");
    if(props.linkAddress){document.getElementById(props.title + "-link").onclick = function(event){if(this.parentElement.className =="card"){event.preventDefault();}};}
    return currentCard;
}
